...
1. Clone the repo
2. Run `global_impact.py` to reproduce the cleaning and EDA steps
3. Open `AI_Jobs_Dashboard.pbix` in Power BI Desktop to explore the interactive dashboard

---

*Built as part of independent data analytics practice — see [my portfolio](https://fizzah-amir14.github.io/Portfolio/) for more.*
